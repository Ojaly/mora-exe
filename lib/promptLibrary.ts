...
export const PROMPT_LIBRARY: PromptLibraryItem[] = [
  ...
  },
  {
    ...
    category: "genre",
    promptText: "corporate electro funk, sterile funk, pale office glow, electronic groove, dystopian soul",
    description: "企業CMのような完璧さと不気味さ。天井灯の下のファンク。感情を排した機能的な陽気さ。",
...

  {
    ...
    category: "texture",
    promptText: "electric hum, institutional ambience, office drone, 60hz buzz",
    description: "60Hzの電気ハム音。施設・オフィス・病院的な冷たさと疎外感。",
  ...
  },
  {
    ...
    label: "cold office",
    category: "texture",
    promptText: "cold office ambience, air conditioning hum, ceiling light flicker, dead acoustic tile",
    description: "エアコンの低い唸りと天井照明のちらつき。吸音材が張られた死んだ音響の職場環境。",
